 ...
 */
public class LensCorrectionEffect implements Effect {
    ...
    public LensCorrectionEffect a(double a) {
        this.a = a;
        return this;
    }

    public LensCorrectionEffect b(double b) {
        this.b = b;
        return this;
    }

    public LensCorrectionEffect c(double c) {
        this.c = c;
        return this;
    }
