...
public class SimpleFishEyeCorrectionEffect implements Effect {

    private float strength = 1f;
    private float zoom = 1;

    public SimpleFishEyeCorrectionEffect() {
        super();
    }
    ...
    public SimpleFishEyeCorrectionEffect strength(float strength) {
        this.strength = strength;
        return this;
    }

    public SimpleFishEyeCorrectionEffect zoom(float zoom) {
        this.zoom = zoom;
        return this;
    }
