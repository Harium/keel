...
public class OpticalFlow implements Effect {
    ...
    public OpticalFlow window(int window) {
        this.window = window;
        return this;
    }

    public OpticalFlow border(int border) {
        this.border = border;
        return this;
    }

    public OpticalFlow image(ImageSource image) {
        this.initial = image;
        return this;
    }
